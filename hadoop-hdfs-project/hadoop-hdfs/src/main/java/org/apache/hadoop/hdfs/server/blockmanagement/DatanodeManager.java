...
public class DatanodeManager {
  ...
  private void removeDatanode(DatanodeDescriptor nodeInfo) {
    ...
    // 非常关键，block一切东西你都大概看明白了
    // 因为这个datanode已经死掉了，所以说在这里，就会从BlockManager中
    // 将这个datanode与block的关联关系都删除
    // 假如说，本来block在datanode01、datanode02、datanode03上面，现在datanode02死掉了
    // 那么就变成，block在datanode01、datanode03上面了
  ...
  public void registerDatanode(DatanodeRegistration nodeReg)
    ...
    try {
      ...
      if (nodeS != null) {
        ...
        // 吐槽一下下，这里的注册的代码逻辑，很明显是那些开源的作者，他们在填充代码，根本没考虑到代码的可读性
        // 开源作者自己本身是搞的明白这些代码的逻辑的
        // 但是，让去阅读开源项目源码的人，会觉得很麻烦
      }
  ...
  public DatanodeCommand[] handleHeartbeat(DatanodeRegistration nodeReg,
    ...
    synchronized (heartbeatManager) {
      synchronized (datanodeMap) {
        ...
        // 在这里，就可以获取到这个Datanode对应的replicatoin复制任务
